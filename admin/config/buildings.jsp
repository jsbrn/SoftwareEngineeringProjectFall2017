...
out.println("<tr> <th>Name</th></tr>");
   while(building.next())
   {
        ...
        out.println("<tr> <td>"+name+"</td><td><a href = 'building.jsp?buildingName="+name+"' name = 'buildingName' class = 'button'>View</a></td><a href = 'addbuilding.jsp?buildingName="+name+"' name = 'buildingName' class = 'button'>+</a></td><a href = 'deletebuilding.jsp?buildingName="+name+"' name = 'buildingName' class = 'button'>X</a></td></tr>");
   }
